	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 col-sm-6">
				<img src="<?php bloginfo('template_directory'); ?>/images/about-img.jpg" class="img-responsive" alt="about img">
			</div>
			<div class="col-md-6 col-sm-6">
				<h3>ABOUT US</h3>
...
<div id="team">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-3 col-sm-6">
				<img src="<?php bloginfo('template_directory'); ?>/images/team4.jpg" class="img-responsive" alt="team img">
				<h3>Mary Sandar</h3>
				<h4>UX Specialist</h4>
			</div>
		</div>
               		...
               		<div class="iso-box-section">
               			<div class="iso-box-wrapper col4-iso-box">
               				...
               				<div class="iso-box html photoshop wordpress mobile col-md-4 col-sm-6 col-xs-12">
               				 	<a href="<?php bloginfo('template_directory'); ?>/images/portfolio-img1.jpg" data-lightbox-gallery="portfolio-gallery"><img src="<?php bloginfo('template_directory'); ?>/images/portfolio-img1.jpg" alt="portfolio img"></a>
               				 </div>

               				 <div class="iso-box html wordpress mobile col-md-4 col-sm-6 col-xs-12">
               				 	<a href="<?php bloginfo('template_directory'); ?>/images/portfolio-img2.jpg" data-lightbox-gallery="portfolio-gallery"><img src="<?php bloginfo('template_directory'); ?>/images/portfolio-img2.jpg" alt="portfolio img"></a>
               				 </div>

               				 <div class="iso-box wordpress col-md-4 col-sm-6 col-xs-12">
               				 	<a href="<?php bloginfo('template_directory'); ?>/images/portfolio-img3.jpg" data-lightbox-gallery="portfolio-gallery"><img src="<?php bloginfo('template_directory'); ?>/images/portfolio-img3.jpg" alt="portfolio img"></a>
               				 </div>

               				 <div class="iso-box html mobile col-md-6 col-sm-6 col-xs-12">
               				 	<a href="<?php bloginfo('template_directory'); ?>/images/portfolio-img4.jpg" data-lightbox-gallery="portfolio-gallery"><img src="<?php bloginfo('template_directory'); ?>/images/portfolio-img4.jpg" alt="portfolio img"></a>
               				 </div>

               				 <div class="iso-box wordpress col-md-6 col-sm-6 col-xs-12">
               				 	<a href="<?php bloginfo('template_directory'); ?>/images/portfolio-img5.jpg" data-lightbox-gallery="portfolio-gallery"><img src="<?php bloginfo('template_directory'); ?>/images/portfolio-img5.jpg" alt="portfolio img"></a>
               				 </div>

               				 <div class="iso-box html photoshop col-md-4 col-sm-6 col-xs-12">
               				 	<a href="<?php bloginfo('template_directory'); ?>/images/portfolio-img6.jpg" data-lightbox-gallery="portfolio-gallery"><img src="<?php bloginfo('template_directory'); ?>/images/portfolio-img6.jpg" alt="portfolio img"></a>
               				 </div>

               				 <div class="iso-box photoshop col-md-4 col-sm-6 col-xs-12">
               				 	<a href="<?php bloginfo('template_directory'); ?>/images/portfolio-img7.jpg" data-lightbox-gallery="portfolio-gallery"><img src="<?php bloginfo('template_directory'); ?>/images/portfolio-img7.jpg" alt="portfolio img"></a>
               				 </div>

               				 <div class="iso-box wordpress col-md-4 col-sm-6 col-xs-12">
               				 	<a href="<?php bloginfo('template_directory'); ?>/images/portfolio-img8.jpg" data-lightbox-gallery="portfolio-gallery"><img src="<?php bloginfo('template_directory'); ?>/images/portfolio-img8.jpg" alt="portfolio img"></a>
               				 </div>
